...
<div className='Contact' >
 ...
 <div className='Contact-Box-1'>
    <div>
        ...
        <label className="btn btn-default" for="a25" style={{display:'flex',justifyContent:'center',alignItems:'center',fontSize:'13px'}}>Software Development</label>
        </div>

        <div className="button">
        <input type="radio" id="a50" name="contactfor" value='Web Development' />
        <label className="btn btn-default" for="a50" style={{display:'flex',justifyContent:'center',alignItems:'center',fontSize:'13px'}}>Web Development</label>
        </div>

        <div className="button">
        <input type="radio" id="a75" name="contactfor" value='Contect Creation' />
        <label className="btn btn-default" for="a75" style={{display:'flex',justifyContent:'center',alignItems:'center',fontSize:'13px'}}>Content Creation</label>
        </div>

        <div className="button">
        <input type="radio" id="a100" name="contactfor" value='Other' />
        <label className="btn btn-default" for="a100" style={{display:'flex',justifyContent:'center',alignItems:'center',fontSize:'13px'}}>Other</label>
        </div>
        </div>
        ...
        <TextField type='text' className='contact-input1-input' id="Your-Email" label="Your Email" name='from_email' variant="standard"  style={{margin:'20px 20px 0px 0px'}}/>
        </div>
