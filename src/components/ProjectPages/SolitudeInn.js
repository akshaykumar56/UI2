...
import Img1 from './SolitudeInn.png'
function Service() {
  return (
<>
<div>
    ...
    <div className='Page-Main'>
        <div className='Page-Main-Heading1' style={{fontFamily:'Red Hat Display',fontWeight:'600'}}>Solitude Inn</div>
        <div className='Page-Main-Heading2' style={{fontFamily:'Red Hat Display'}}>To create a website that would not only showcase its unique offerings but also increase its footfall</div>
        <div className='Page-Main-1'>
            <div className='Page-Main-1-1'>
                ...
                <div style={{margin:'10px 0px',fontFamily:'Red Hat Display',fontSize:'18px',fontWeight:'400',textAlign:'justify'}}>This project aimed to leverage the power of the web to make a significant online appearance, attract more guests, and enhance the hotel's overall visibility.The development of a website for Solitude Inn has been instrumental in elevating the hotel's online presence, attracting more guests, and enhancing its visibility.</div>
                </div>
            </div>
        ...
        <a href='https://solitudeinnshimla.com/'  target='_blank' rel="noreferrer" style={{textDecoration:'none'}}><div className='site-Button' style={{borderRadius:'24px',backgroundColor:'#65c891',display:'flex',justifyContent:'center',alignItems:'center',height:'40px',color:'white'}}>Preview</div></a>
        </div>
    </div>
</div>
</>
