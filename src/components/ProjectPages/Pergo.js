...
<div>
    ...
    <div className='Page-Main'>
        <div className='Page-Main-Heading1' style={{fontFamily:'Red Hat Display',fontWeight:'600'}}>Pergo</div>
        <div className='Page-Main-Heading2' style={{fontFamily:'Red Hat Display'}}>A Dynamic Website with blogging facility</div>
        <div className='Page-Main-1'>
            <div className='Page-Main-1-1'>
                ...
                <div style={{margin:'10px 0px',fontFamily:'Red Hat Display',fontSize:'18px',fontWeight:'400',textAlign:'justify'}}>The creation of a dynamic website for Pergo NGO has provided them with a powerful digital platform to communicate their mission and achievements effectively. With a lightweight design, blogging capabilities, and engaging content, the website serves as a vital tool in Pergo's efforts to make a positive impact on society, raising awareness and support for their noble cause.</div>
                </div>
            </div>
        ...
        <a href='https://pergo.org.in/' target='_blank' rel="noreferrer" style={{textDecoration:'none'}}><div className='site-Button' style={{borderRadius:'24px',backgroundColor:'#65c891',display:'flex',justifyContent:'center',alignItems:'center',height:'40px',color:'white'}}>Preview</div></a>
        </div>
    </div>
</div>
</>
