...
import Img1 from './CreativeCoaching.png'
function Service() {
  return (
<>
<div>
    ...
    <div className='Page-Main'>
        <div className='Page-Main-Heading1' style={{fontFamily:'Red Hat Display',fontWeight:'600'}}>Creative Coaching Classes</div>
        <div className='Page-Main-Heading2' style={{fontFamily:'Red Hat Display'}}>Project aimed to develop a dynamic website that not only showcased their wide range of classes</div>
        <div className='Page-Main-1'>
            <div className='Page-Main-1-1'>
                ...
                <div style={{margin:'10px 0px',fontFamily:'Red Hat Display',fontSize:'18px',fontWeight:'400',textAlign:'justify'}}>This project aimed to develop a dynamic website that not only showcased their wide range of classes but also highlighted the remarkable achievements of their past students. The creation of a dynamic website for Creative Coaching Classes has significantly empowered the institute to reach a wider audience, effectively communicate its offerings, and highlight its remarkable student achievements.</div>
                </div>
            </div>
        ...
        <a href='https://creativecoachingclassesshimla.com/' target='_blank' rel="noreferrer" style={{textDecoration:'none'}}><div className='site-Button' style={{borderRadius:'24px',backgroundColor:'#65c891',display:'flex',justifyContent:'center',alignItems:'center',height:'40px',color:'white'}}>Preview</div></a>
        </div>
    </div>
</div>
</>
